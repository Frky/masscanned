...
mod http;
use http::{HTTP_VERBS, ProtocolState as HTTPProtocolState};
...
mod rpc;
use rpc::{RPC_CALL, ProtocolState as RPCProtocolState};
...
pub fn repl<'a>(
    ...
    match id {
        ...
        PROTO_RPC => rpc::repl(data, masscanned, &mut client_info, tcb),
        _ => {
            debug!("id: {}", id);
            None
        }
